...
namespace Gestion_de_Musica.Controllers
{
    ...
    public class ArtistasController : ControllerBase
    {
        ...
        public ArtistasController(MusicaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Artista>> PostArtista(Artista artista)
        {
            ...
            return CreatedAtAction("GetArtista", new { id = artista.artista_id }, artista);
        }
        ...
        {
            return _context.Artistas.Any(e => e.artista_id == id);
        }
    }
}
